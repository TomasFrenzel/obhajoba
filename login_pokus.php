...
<sesion id='login-section' class='container d-flex  align-items-center flex-column full-section color'>
            <h2 class='display-3 fw-bold text-white p-4'>Přhlásit <span class='colored-text'>se</span></h2>

            <form action='login_test.php' method='post' class='d-flex flex-column align-items-center'>

                <input type='email'
                placeholder='Email' 
                name='email' 
                class='form-input m-2 p-2'><br>
            ...
            <h5 class='text-white mt-2'>Ještě nemáte učet?</h5>
            <a href='./register_test.php' class='mt-2 login-icon'><img src='./img/login.svg' alt='logo'></a>
            </section>";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if ($result->num_rows == 1) {
                    ...
                    if ($verify === 1){
                        ...
                        }elseif (password_verify(secouredPass($password), $passDat)){
